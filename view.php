    ...
    <div class="container mt-5">
        ...
        <div class="bg-dark p-5 rounded-lg text-white text-center">
            ...
            <div class="d-flex mt-2 justify-content-center align-items-center">
                <a href="edit.php?id=<?php echo $row['id'] ?>" class="btn btn-light btn-sm" name="edit">Edit</a>
                <form method="POST">
        ...
        <form class="row" method="post">
            <input type=" text" placeholder="Comment" class="form-control bg-dark text-white text-center col-8" name="comment">
            <div class="col-4">
                <input type="number" hidden name="postId" value="<?php echo $row['id']; ?>">
                <button class="btn btn-dark" name="new_comment">Add Comment</button>
            </div>
        </form>
    </div>
